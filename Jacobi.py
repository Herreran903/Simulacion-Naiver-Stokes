...
## Calcula la tolerancia normalizada infinita.
...
## Solución para Vx
## Ya que el vector bvx es diferente de 0, utilizamos el vector 0 como solución inicial.
cero = np.zeros(len(Avx))
solVx = solveUsingJacobi(Avx, bvx, cero, 1.05, 0.001)
print(solVx)

## Solución para Vy
## Ya que el vector bvy es igual al vector 0, utilizamos un vector de 0.1 como solución inicial.
solIniy = np.full(len(Avy), 1)
solVy = solveUsingJacobi(Avy, bvy, solIniy, 1.5, 0.001)
print(solVy)